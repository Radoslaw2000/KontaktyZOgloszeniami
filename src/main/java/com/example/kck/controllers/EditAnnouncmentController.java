...
public class EditAnnouncmentController{
    @FXML
    ...
    public void zapiszButtonAction(ActionEvent event) throws IOException {
        ...
        tytul.setText("Edytowano ogłoszenie");
    ...
    public void initialize(Announcment announcment) {
        ...
        titleTextField.setText(announcment.getTitle());
        priceTextField.setText(announcment.getPrice());
        categoryComboBox.getSelectionModel().select(announcment.getCategory());
        phoneNumberTextField.setText(announcment.getPhoneNumber());
        townTextField.setText(announcment.getTown());
        voivodeshipComboBox.getSelectionModel().select(announcment.getVoivodeship());
